...
const CommentInputBox = ({ postId, setAllComments }) => {
    ...
    return (
        <>
            <div className="mt-6 p-4 border-t-2 w-full">
                <textarea
                    className="w-full p-3 text-sm md:text-base text-gray-700 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-700 focus:outline-none transition duration-200 ease-in-out"
                ...
                <button
                    ...
                    className="mt-3 px-4 py-2 bg-primary text-white text-xs md:text-base font-semibold rounded-lg hover:bg-green-600 focus:outline-none transition duration-200 ease-in-out"
