        ...
        <div className="w-screen h-screen bg-white py-4 rounded-[20px]">
            ...
            <section className="flex flex-row justify-between items-center gap-6 p-10">
                <div className="flex flex-col items-start justify-center ml-20 ">
                    <h1 className="text-4xl text-[#2d6a4f] font-poppins font-bold py-10">
                        Hi, welcome to PlantPal
                    </h1>
                    <p className="text-lg text-[#1b4332] font-inter font-semibold ">
                        A plant care tracker and community for house plant
                        lovers.
                    </p>
                    <p className="text-base mb-10 text-left font-poppins font-regular">
                    ...
                    <button
                        onClick={handleClick}
                        className="bg-[#2d6a4f] text-white font-semibold py-4 px-8 rounded-full shadow-lg"
                    >
            ...
            <section className="py-10 px-6">
                ...
                <div className="flex flex-row items-center gap-8">
                    ...
                    <div className="p-8 m-4 rounded-lg shadow max-w-md w-full">
                        <p className="text-[#767676] font-poppins font-regular">
            ...
            <footer className="py-16 px-6 text-center text-white bg-[#2d6a4f]">
                <div className="flex flex-row justify-center space-x-20 items-center mb-8">
                    ...
                    <div className="flex flex-wrap justify-center space-x-6 text-lg font-inter font-regular">
                        <a
                            href="#"
                            className="hover:text-[#d9ff43] transition duration-300"
                        >
                            About Us
                        </a>
                        <a
                ...
                <div className="mt-8 pt-8 border-t font-poppins font-regular">
