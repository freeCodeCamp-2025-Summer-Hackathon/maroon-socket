        ...
        <div className="w-full h-full bg-white py-4 rounded-[20px]">
            ...
            <nav className="bg-white shadow-md flex justify-between items-center w-full p-8 rounded-b-lg">
                <div className="flex items-center px-4">
                    <span className="text-2xl font-bold text-[#2d6a4f]">PlantPal</span>
                </div>
            ...
            <section className="py-10 px-6">
                ...
                <div className="flex flex-row items-center gap-8">
                    <div className="p-8 m-4 rounded-lg shadow max-w-md w-full">
                        <p className="text-[#767676]">&quot;This app has been a game-changer for my indoor gardening. The reminders are spot on!&quot;</p>
                    </div>
                    <div className="p-8 m-4 rounded-lg shadow max-w-md w-full" >
                        <p className="text-[#767676]">&quot;The community features are fantastic! I've learned so much from other plant lovers.&quot;</p>
                    </div>
                    <div className="p-8 m-4 rounded-lg shadow max-w-md w-full" >
                        <p className="text-[#767676]">&quot;The best app for plant lovers! I can track my plants' needs and connect with others.&quot;</p>
                    </div>
                </div>
            </section>
            <div class="w-40 h-1 bg-[#2d6a4f] rounded-full mx-auto my-4"></div>
            ...
            <footer className="py-16 px-6 text-center text-white bg-[#2d6a4f]" >
                <div className="flex flex-row justify-center space-x-20 items-center mb-8">
                    <div className="mb-8">
                        ...
                        <p className="text-sm mt-2" >&copy; 2023 PlantPal. All rights reserved.</p>
                    </div>
                    <div className="flex flex-wrap justify-center space-x-6 text-lg">
                        <a href="#" className="hover:text-[#52b788] transition duration-300">About Us</a>
                        <a href="#" className="hover:text-[#52b788] transition duration-300">Features</a>
                        <a href="#" className="hover:text-[#52b788] transition duration-300">Privacy Policy</a>
                        <a href="#" className="hover:text-[#52b788] transition duration-300">Terms of Service</a>
                        <a href="#" className="hover:text-[#52b788] transition duration-300">Contact</a>
                    </div>
                </div>
