...
function LandingPage() {
    return (
        <div
            className="w-full h-full relative scroll-smooth scroll-mt-20"
            id="home"
        >
            <NavBar />
            ...
            <main className="w-full h-full mt-24">
                ...
                <section className="relative h-[89vh] w-full py-5">
                    <div className="flex flex-col justify-center items-center gap-4 h-2/5 px-4 text-center">
                        <h1 className="font-poppins text-4xl font-bold ">
                            ...
                            <span className="text-primary text-4xl font-poppins font-bold">
                                Plant
                            </span>{' '}
                            Happy
                        </h1>
                        <div className="w-full flex flex-col justify-center items-center gap-8 -mt-2">
                            <p className="font-poppins text-base text-gray-500">
                                ...
                                progress, and connect with a plant-loving
                                community.
                            </p>
                            {/** Call to action */}
                            <Link to={'/login'}>
                ...
                <section className="flex justify-around items-center gap-14 h-[120vh] w-full relative bg-btn ">
                    ...
                    <div className="w-2/5 h-full bg-btn flex flex-col justify-center">
                        <blockquote className="font-poppins font-bold text-white text-6xl leading-normal text-center">
                            " To nurture a plant <br></br> is to slow down,{' '}
                            <br></br>pay attention,<br></br> and grow alongside
                            it. "
                        </blockquote>
                    </div>
                </section>
