  ...
  return (
    <div className="w-full h-full px-12 py-16 flex flex-col justify-center items-center gap-12 relative pt-16">
       ...
       <div className="flex flex-col justify-center items-center mb-11">
           <h2 className="font-poppins font-bold text-4xl">Welcome to the PlantCare Community</h2>
           <p className=" font-poppins text-sm text-gray-600">Share tips, ask questions, and connect with fellow plant lovers.</p>
       </div>
        {/** Create POST Button */}
